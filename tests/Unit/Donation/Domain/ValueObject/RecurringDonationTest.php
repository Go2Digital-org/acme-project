...
describe('Recurring Donation Logic', function () {
    beforeEach(function () {
    ...
    describe('Recurring Frequency Validation', function () {
        it('validates daily recurring frequency', function () {
            $frequency = 'daily';

            expect($frequency)->toBe('daily');
        });

        it('validates weekly recurring frequency', function () {
            $frequency = 'weekly';

            expect($frequency)->toBe('weekly');
        });

        it('validates monthly recurring frequency', function () {
            $frequency = 'monthly';

            expect($frequency)->toBe('monthly');
        });

        it('validates quarterly recurring frequency', function () {
            $frequency = 'quarterly';

            expect($frequency)->toBe('quarterly');
        });

        it('validates yearly recurring frequency', function () {
            $frequency = 'yearly';

            expect($frequency)->toBe('yearly');
        });

        it('identifies valid recurring frequencies', function () {
        ...
        it('rejects invalid recurring frequencies', function () {
    ...
    describe('Recurring Donation Business Rules', function () {
        it('calculates next donation date for daily frequency', function () {
        ...
        it('calculates next donation date for weekly frequency', function () {
            $startDate = Carbon::parse('2024-01-15');
            $frequency = 'weekly';
        ...
        it('calculates next donation date for monthly frequency', function () {
            $startDate = Carbon::parse('2024-01-15');
            $frequency = 'monthly';
        ...
        it('calculates next donation date for quarterly frequency', function () {
            $startDate = Carbon::parse('2024-01-15');
            $frequency = 'quarterly';
        ...
        it('calculates next donation date for yearly frequency', function () {
            $startDate = Carbon::parse('2024-01-15');
            $frequency = 'yearly';
        ...
        it('handles leap year for yearly recurring donations', function () {
        ...
        it('handles month-end dates for monthly recurring', function () {
    ...
    describe('Recurring Donation Amount Validation', function () {
        it('validates minimum recurring donation amount', function () {
        ...
        it('rejects recurring donations below minimum threshold', function () {
        ...
        it('validates maximum recurring donation amount', function () {
        ...
        it('calculates total recurring amount over time periods', function () {
        ...
        it('calculates prorated amount for partial periods', function () {
            $monthlyAmount = new Amount(100.00, 'EUR');
            $days = 15;
            $monthDays = 30;
    ...
    describe('Payment Method Compatibility', function () {
        it('allows credit cards for recurring donations', function () {
        ...
        it('allows Stripe for recurring donations', function () {
        ...
        it('allows PayPal for recurring donations', function () {
        ...
        it('rejects bank transfer for recurring donations', function () {
        ...
        it('validates payment method supports currency for recurring donations', function () {
            $paymentMethod = PaymentMethod::CARD;
            $currency = 'EUR';
        ...
        it('checks minimum amount requirements per payment method', function () {
            $paymentMethod = PaymentMethod::STRIPE;
            $currency = 'EUR';
    ...
    describe('Recurring Donation Lifecycle', function () {
        it('creates recurring donation schedule', function () {
            $startDate = Carbon::parse('2024-01-15');
        ...
        it('handles failed recurring donation attempts', function () {
            $donation = [
                'id' => 1,
                'amount' => 50.00,
        ...
        it('determines when to stop retrying failed recurring donations', function () {
            $donation = [
                'retry_count' => 3,
                'max_retries' => 3,
            ];
        ...
        it('calculates next retry date with exponential backoff', function () {
    ...
    describe('Recurring Donation Cancellation', function () {
        it('allows cancellation of future recurring donations', function () {
            $donation = [
                'recurring' => true,
        ...
        it('prevents cancellation of already cancelled recurring donations', function () {
            $donation = [
                'recurring' => true,
        ...
        it('calculates refund amount for cancelled recurring donations', function () {
            $monthlyAmount = new Amount(100.00, 'EUR');
            $totalPaid = 5; // months
    ...
    describe('Recurring Donation Tax Receipt Generation', function () {
        it('generates yearly tax receipt for recurring donations', function () {
            $monthlyAmount = new Amount(100.00, 'EUR');
            $donationsCount = 12;
        ...
        it('tracks recurring donations for tax receipt eligibility', function () {
            $donations = [
    ...
    describe('Recurring Donation Frequency Calculations', function () {
        it('calculates daily frequency in days', function () {
            $frequency = 'daily';
            $days = 1;
        ...
        it('calculates weekly frequency in days', function () {
            $frequency = 'weekly';
            $days = 7;
        ...
        it('calculates monthly frequency in approximate days', function () {
            $frequency = 'monthly';
            $days = 30; // Approximate
        ...
        it('calculates quarterly frequency in days', function () {
            $frequency = 'quarterly';
        ...
        it('calculates yearly frequency in days', function () {
            $frequency = 'yearly';
        ...
        it('handles leap year calculations for yearly frequency', function () {
            $year = 2024; // Leap year
    ...
    describe('Recurring Donation Analytics', function () {
        it('calculates average donation amount for recurring donations', function () {
        ...
        it('calculates retention rate for recurring donations', function () {
            $totalRecurring = 100;
            $activeRecurring = 85;
        ...
        it('calculates churn rate for recurring donations', function () {
            $totalRecurring = 100;
        ...
        it('calculates lifetime value of recurring donor', function () {
    ...
    describe('Recurring Donation Status Transitions', function () {
        it('transitions from pending to processing for recurring donations', function () {
        ...
        it('transitions from processing to completed for recurring donations', function () {
        ...
        it('prevents invalid status transitions for recurring donations', function () {
    ...
    describe('Recurring Donation Edge Cases', function () {
        it('handles weekend scheduling for business days only', function () {
        ...
        it('handles holiday scheduling adjustments', function () {
        ...
        it('handles timezone considerations for recurring donations', function () {
        ...
        it('handles currency exchange rate changes for international recurring donations', function () {
    ...
    describe('Recurring Donation Validation Rules', function () {
        it('validates recurring donation end date is after start date', function () {
            $startDate = Carbon::parse('2024-01-15');
        ...
        it('validates maximum recurring donation duration', function () {
            $startDate = Carbon::parse('2024-01-15');
        ...
        it('validates minimum occurrences for recurring donations', function () {
            $frequency = 'monthly';
            $startDate = Carbon::parse('2024-01-15');
