...
describe('TwoFactorEnabledEvent', function () {
    ...
    describe('Construction', function () {
        ...
        it('creates event with default backup codes generated when not provided', function () {
            $userId = 123;
            $ipAddress = '192.168.1.1';
        ...
        it('creates event with backup codes disabled', function () {
    ...
    describe('Getters', function () {
        ...
        it('returns correct backup codes generated status', function () {
    ...
    describe('Domain Event Interface Methods', function () {
        ...
        it('returns correct event data with backup codes enabled', function () {
            $userId = 789;
        ...
        it('returns correct event data with backup codes disabled', function () {
            $userId = 789;
            $ipAddress = '172.16.0.1';
            $userAgent = 'Test User Agent';
    ...
    describe('Backup Codes Feature', function () {
        it('correctly identifies when backup codes are generated', function () {
            $eventWithBackup = new TwoFactorEnabledEvent(123, '192.168.1.1', 'User Agent', true);
            $eventWithoutBackup = new TwoFactorEnabledEvent(123, '192.168.1.1', 'User Agent', false);
        ...
        it('includes backup codes status in event data', function () {
            $eventWithBackup = new TwoFactorEnabledEvent(123, '192.168.1.1', 'User Agent', true);
            $eventWithoutBackup = new TwoFactorEnabledEvent(123, '192.168.1.1', 'User Agent', false);
        ...
        it('defaults to backup codes generated when not specified', function () {
            $event = new TwoFactorEnabledEvent(123, '192.168.1.1', 'User Agent');
    ...
    describe('Real-world Scenarios', function () {
        ...
        it('represents scenario where user enables 2FA with backup codes', function () {
        ...
        it('represents scenario where user enables 2FA without backup codes', function () {
            $event = new TwoFactorEnabledEvent(
                userId: 456,
                ipAddress: '10.0.0.50',
    ...
    describe('Comparison with PasswordChangedEvent', function () {
        it('has different event name than password changed event', function () {
        ...
        it('has additional backup codes field compared to password changed event', function () {
            $twoFactorEvent = new TwoFactorEnabledEvent(123, '192.168.1.1', 'User Agent');
