...
describe('Category Status Domain Logic', function () {
...
describe('Category Status String Representation', function () {
    it('has correct value property', function () {
        expect(CategoryStatus::ACTIVE->value)->toBe('active')
            ->and(CategoryStatus::INACTIVE->value)->toBe('inactive');
    });

    it('can access values for string operations', function () {
...
describe('Category Status Labels and Colors', function () {
