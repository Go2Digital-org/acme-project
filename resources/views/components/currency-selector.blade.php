<div class="relative" x-data="{ open: false }">
    ...
    <div class="hidden md:block">
        ...
        >
            @if($currentCurrency)
                <span class="text-lg">{{ $currentCurrency->flag }}</span>
            ...
            <div class="py-1" role="none">
                @foreach($availableCurrencies as $currency)
                    <a
                        ...
                        class="flex items-center w-full px-4 py-2 text-sm text-left text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-200 dark:hover:bg-gray-700 {{ $currentCurrency && $currentCurrency->code === $currency->code ? 'bg-gray-50 dark:bg-gray-700' : '' }}"
                        role="menuitem"
                    >
    ...
    <div class="md:hidden">
        ...
        >
            <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                <p class="text-sm font-medium text-gray-900 dark:text-gray-100">Select Currency</p>
            </div>
            <div class="py-2" role="none">
                @foreach($availableCurrencies as $currency)
                    <a
                        href="{{ route('currency.switch', $currency->code) }}"
                        class="flex items-center w-full px-4 py-3 text-sm text-left text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-200 dark:hover:bg-gray-700 {{ $currentCurrency && $currentCurrency->code === $currency->code ? 'bg-gray-50 dark:bg-gray-700' : '' }}"
                        role="menuitem"
                    >
