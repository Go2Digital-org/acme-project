...
namespace Modules\Shared\Infrastructure\ApiPlatform\Handler\Provider;
...
final readonly class NotificationCollectionProvider implements ProviderInterface
{
    ...
    /**
     * @return Paginator<NotificationResource>|array<NotificationResource>
     */
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): Paginator|array
    {
        ...
        // Query the custom notifications table directly
        $query = DB::table('notifications')->where('recipient_id', (string) $user->id);
        ...
        return new Paginator(
            new ArrayIterator($resources->all()),
            $currentPage,
            $perPage,
            $lastPage,
            $total,
