...
final class DonationCancelledEvent extends AbstractDomainEvent
{
    public function __construct(
        ...
        public readonly int $cancelledByEmployeeId,
    ) {
    ...
    public function getEventData(): array
    {
        return array_merge(parent::getEventData(), [
            ...
            'cancelledByEmployeeId' => $this->cancelledByEmployeeId,
        ]);
    }
}
