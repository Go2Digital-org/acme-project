...
final readonly class ListPendingDonationsQueryHandler implements QueryHandlerInterface
{
    ...
    {
        if (! $query instanceof ListPendingDonationsQuery) {
            throw new InvalidArgumentException('Invalid query type');
        }

        return $this->repository->findPendingDonations();
    }
}
